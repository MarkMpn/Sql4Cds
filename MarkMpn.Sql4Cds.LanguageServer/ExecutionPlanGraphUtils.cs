...
{
    class ExecutionPlanGraphUtils
    {
        public static List<ExecutionPlanGraph> CreateShowPlanGraph(string xml, string fileName)
        {
            ShowPlanGraph[] graphs = ShowPlanGraph.ParseShowPlanXML(xml, Microsoft.SqlTools.ServiceLayer.ExecutionPlan.ShowPlan.ShowPlanType.Unknown);
