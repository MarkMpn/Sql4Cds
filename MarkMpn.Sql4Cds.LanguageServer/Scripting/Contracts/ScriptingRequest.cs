...
namespace Microsoft.SqlTools.ServiceLayer.Scripting.Contracts
{
    ...
    {
        public const string MessageName = "scripting/script";

        public static readonly LspRequest<ScriptingParams, ScriptingResult> Type = new LspRequest<ScriptingParams, ScriptingResult>(MessageName);
    }
}