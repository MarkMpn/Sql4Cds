...
using MarkMpn.Sql4Cds.LanguageServer;
...
namespace MarkMpn.Sql4Cds
{
    ...
    public class Autocomplete
    {
        ...
        class TVFAutocompleteItem : SqlAutocompleteItem
        {
            ...
            public TVFAutocompleteItem(Message message, int replaceLength) : base(message.Name, replaceLength, CompletionItemKind.Function)
            {
                _message = message;
            }
        ...
        class SprocAutocompleteItem : SqlAutocompleteItem
        {
            ...
            public SprocAutocompleteItem(Message message, int replaceLength) : base(message.Name, replaceLength, CompletionItemKind.Method)
            {
                _message = message;
            }
        ...
        class JoinAutocompleteItem : SqlAutocompleteItem
        {
            ...
            public JoinAutocompleteItem(OneToManyRelationshipMetadata relationship, string join, bool oneToMany, EntityMetadata[] entities, IAttributeMetadataCache metadata, int replaceLength) : base(join, replaceLength, CompletionItemKind.Snippet)
            {
