...
namespace MarkMpn.Sql4Cds.Engine.ExecutionPlan
{
    ...
    static class ExpressionExtensions
    {
        ...
        private static readonly ConcurrentDictionary<string, bool> _validIdentifiers = new ConcurrentDictionary<string, bool>(StringComparer.OrdinalIgnoreCase);
        ...
        public static bool IsValidIdentifier(this string identifier)
        {
            ...
            return _validIdentifiers.GetOrAdd(identifier, _parser.ValidateIdentifier);
        }
