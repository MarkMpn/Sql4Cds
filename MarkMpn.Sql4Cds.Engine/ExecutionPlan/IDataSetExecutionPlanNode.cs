...
namespace MarkMpn.Sql4Cds.Engine.ExecutionPlan
{
    ...
    internal interface IDataSetExecutionPlanNode : IRootExecutionPlanNodeInternal
    {
        ...
        DataTable Execute(IDictionary<string, DataSource> dataSources, IQueryExecutionOptions options, IDictionary<string, DataTypeReference> parameterTypes, IDictionary<string, object> parameterValues, CancellationToken cancellationToken);
    }
}
