...
| Privacy and diagnostics | VS Code service process uses global storage for token caching, and redacts common credential forms in displayed connection errors. | [client](src/serviceClient.ts), [error handling](src/documentConnections.ts), [README](README.md) |
