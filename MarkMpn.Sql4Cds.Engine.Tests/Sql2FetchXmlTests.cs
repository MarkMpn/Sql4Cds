...
namespace MarkMpn.Sql4Cds.Engine.Tests
{
    ...
    public class Sql2FetchXmlTests : FakeXrmEasyTestsBase, IQueryExecutionOptions
    {
        ...
        public void SelectArithmetic()
        {
            ...
            var dataReader = ((SelectNode)queries[0]).Execute(new NodeExecutionContext(new SessionContext(GetDataSources(_context), this), this, new Dictionary<string, DataTypeReference>(), new Dictionary<string, INullable>(), null), CommandBehavior.Default);
        ...
        public void UpdateFieldToField()
        {
            ...
            ((UpdateNode)queries[0]).Execute(new NodeExecutionContext(new SessionContext(GetDataSources(_context), this), this, new Dictionary<string, DataTypeReference>(), new Dictionary<string, INullable>(), null), out _, out _);
        ...
        public void AggregateQueryProducesAlternative()
        {
            ...
            var dataReader = alternativeQuery.Execute(new NodeExecutionContext(new SessionContext(GetDataSources(_context), this), this, new Dictionary<string, DataTypeReference>(), new Dictionary<string, INullable>(), null), CommandBehavior.Default);
            var dataTable = new DataTable();
            dataTable.Load(dataReader);
        ...
        public void GuidEntityReferenceInequality()
        {
            using (_localDataSource.SetColumnComparison(false))
            {
                ...
                var dataReader = select.Execute(new NodeExecutionContext(new SessionContext(GetDataSources(_context), this), this, new Dictionary<string, DataTypeReference>(), new Dictionary<string, INullable>(), null), CommandBehavior.Default);
                var dataTable = new DataTable();
                dataTable.Load(dataReader);
        ...
        public void UpdateGuidToEntityReference()
        {
            ...
            update.Execute(new NodeExecutionContext(new SessionContext(GetDataSources(_context), this), this, new Dictionary<string, DataTypeReference>(), new Dictionary<string, INullable>(), null), out _, out _);
        ...
        public void QuotedIdentifierError()
        {
            ...
            try
            {
                var planBuilder = new ExecutionPlanBuilder(new SessionContext(_localDataSources, new OptionsWrapper(this) { QuotedIdentifiers = true }), new OptionsWrapper(this) { QuotedIdentifiers = true });
                var queries = planBuilder.Build(query, null, out _);
        ...
        public void GlobalOptionSet()
        {
            ...
            var dataReader = selectNode.Execute(new NodeExecutionContext(new SessionContext(GetDataSources(_context), this), this, new Dictionary<string, DataTypeReference>(), new Dictionary<string, INullable>(), null), CommandBehavior.Default);
            var dataTable = new DataTable();
            dataTable.Load(dataReader);
        ...
        public void AttributeDetails()
        {
            ...
            Assert.AreEqual("versionnumber", dataTable.Rows[row++]["logicalname1"]);
        }
        ...
        private void BuildTDSQuery(Action<ExecutionPlanBuilder> action)
        {
            ...
            try
            {
                var planBuilder = new ExecutionPlanBuilder(new SessionContext(_localDataSources, new OptionsWrapper(this) { UseTDSEndpoint = true }), new OptionsWrapper(this) { UseTDSEndpoint = true });
                action(planBuilder);
            }
            finally
            {
